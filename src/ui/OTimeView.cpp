...
#include "res/timeview.h"

OTimeView::OTimeView(IOMainWnd* wnd) : Gtk::Box(), m_box(0), m_daw_time(0) {

    
    Glib::RefPtr<Gtk::Builder> ui = Gtk::Builder::create_from_string(timeview_inline_glade);
